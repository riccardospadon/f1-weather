...
export default function Main() {
    ...
    const circuitLayouts = {
        Sakhir: "https://media.formula1.com/image/upload/f_auto/q_auto/v1677245035/content/dam/fom-website/2018-redesign-assets/Track%20icons%204x3/Bahrain%20carbon.png.transform/3col/image.png",
        Jeddah: "https://media.formula1.com/image/upload/f_auto/q_auto/v1677245030/content/dam/fom-website/2018-redesign-assets/Track%20icons%204x3/Saudi%20Arabia%20carbon.png.transform/3col/image.png",
        Melbourne:
        ...
        Suzuka: "https://media.formula1.com/image/upload/f_auto/q_auto/v1677245031/content/dam/fom-website/2018-redesign-assets/Track%20icons%204x3/Japan%20carbon.png.transform/3col/image.png",
        Shanghai:
            "https://media.formula1.com/image/upload/content/dam/fom-website/2018-redesign-assets/Track%20icons%204x3/China%20carbon.png.transform/3col/image.png",
        ...
        Montréal:
            "https://media.formula1.com/image/upload/content/dam/fom-website/2018-redesign-assets/Track%20icons%204x3/Canada%20carbon.png.transform/5col/image.png",
        Barcelona:
            "https://media.formula1.com/image/upload/f_auto/q_auto/v1680529432/content/dam/fom-website/2018-redesign-assets/Track%20icons%204x3/Spain%20carbon.png.transform/5col/image.png",
        Spielberg:
        ...
        Austin: "https://media.formula1.com/image/upload/f_auto/q_auto/v1677245035/content/dam/fom-website/2018-redesign-assets/Track%20icons%204x3/USA%20carbon.png.transform/5col/image.png",
        "Mexico City":
            "https://media.formula1.com/image/upload/content/dam/fom-website/2018-redesign-assets/Track%20icons%204x3/Mexico%20carbon.png.transform/5col/image.png",
        "São Paulo":
            "https://media.formula1.com/image/upload/content/dam/fom-website/2018-redesign-assets/Track%20icons%204x3/Brazil%20carbon.png.transform/5col/image.png",
        "Las Vegas":
        ...
        Lusail: "https://media.formula1.com/image/upload/f_auto/q_auto/v1677245031/content/dam/fom-website/2018-redesign-assets/Track%20icons%204x3/Qatar%20carbon.png.transform/5col/image.png",
        "Yas Island":
    ...
    const countryFlags = {
        Sakhir: "https://flagcdn.com/bh.svg",
        Jeddah: "https://flagcdn.com/sa.svg",
        Melbourne: "https://flagcdn.com/au.svg",
        Suzuka: "https://flagcdn.com/jp.svg",
        Shanghai: "https://flagcdn.com/cn.svg",
        Miami: "https://flagcdn.com/us.svg",
        Imola: "https://flagcdn.com/it.svg",
        Monaco: "https://flagcdn.com/mc.svg",
        Montréal: "https://flagcdn.com/ca.svg",
        Barcelona: "https://flagcdn.com/es.svg",
        Spielberg: "https://flagcdn.com/at.svg",
        Silverstone: "https://flagcdn.com/gb.svg",
        Budapest: "https://flagcdn.com/hu.svg",
        "Spa-Francorchamps": "https://flagcdn.com/be.svg",
        Zandvoort: "https://flagcdn.com/nl.svg",
        Monza: "https://flagcdn.com/it.svg",
        Baku: "https://flagcdn.com/az.svg",
        "Marina Bay": "https://flagcdn.com/sg.svg",
        Austin: "https://flagcdn.com/us.svg",
        "Mexico City": "https://flagcdn.com/mx.svg",
        "São Paulo": "https://flagcdn.com/au.svg",
        "Las Vegas": "https://flagcdn.com/us.svg",
        Lusail: "https://flagcdn.com/qa.svg",
        "Yas Island": "https://flagcdn.com/ae.svg",
    }
...
this allows to rapidly assign an increasing delay in the script, to have the dashes animated in sequence */}
                    ...
                    <>
                        <h1 className={cn(styles.title)}>
                            ⛅ Look the weather of your favourite Grand Prix! 🏁
                        </h1>
                        <Row className="mt-5">
                            {sortedCircuits.map((circuit, i) => (
                                <CircuitCard
                                    circuit={circuit}
                                    layout={circuitLayouts[circuit.location]}
                                    flag={countryFlags[circuit.location]}
                                    key={i}
                                />
                            ))}
                        </Row>
